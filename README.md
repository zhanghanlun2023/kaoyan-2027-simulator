...
一个同时提供 GitHub Pages 与 Streamlit 版本的全国硕士研究生招生考试训练系统。当前覆盖 8 门统考科目、936 个原创作答项、2022—2026 五年真题索引、全日制/非全日制路径、MBA报考路径和全部原985/211院校选择。
...
- MBA关联共691个作答项：199管理类综合能力3套完整卷、每套57个作答项，共171题；英语二520个作答项。199逻辑包含独立长材料与4个“一材三问”题组，换卷时整套替换且题组不拆散。
- 英语二不使用孤立词汇或语法题冒充套卷；完形和阅读必须依托整篇文章或整组材料展示。
