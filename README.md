...
一个同时提供 GitHub Pages 与 Streamlit 版本的全国硕士研究生招生考试训练系统。当前覆盖 8 门统考科目、402 道原创参数化专项题、2022—2026 五年真题索引、全日制/非全日制路径、MBA报考路径和全部原985/211院校选择。

> 截至 2026-08-22，全国统考科目的 2027 官方考试大纲尚未发布。本项目不会把预测内容标为官方考纲。
...
- MBA是工商管理专业学位路径，不等同于非全日制；系统支持常见的“非全日制 + MBA”配置，并按199管理类综合能力与204英语（二）组织训练。
- 主观写作题只提供人工自评要点，不用关键词匹配伪造正式分数；抽样小测分数不可直接外推到正式考试总分。
